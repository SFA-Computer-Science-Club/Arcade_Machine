"""
A generalized state machine. For program flow. Used by all states.
"""
...
class StateMachine(object):
    ...
    def setup_states(self, state_dict, start_state):
        """
        Creates the self.state_dict when given a dictionary of states and the state to start in.
        """
